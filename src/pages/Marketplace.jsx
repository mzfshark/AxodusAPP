...
<span className="px-3 py-1 bg-secondary/20 text-secondary text-[10px] font-black uppercase tracking-tighter rounded-full border-secondary/30">Trending Now</span>
...
{/*  Floating Data Card  */}
<div className="absolute bottom-8 right-8 glass-panel p-6 rounded-2xl border-outline-variant/20 hidden lg:block">
...
{/*  Card 1  */}
<div className="bg-surface-container-low rounded-2xl overflow-hidden group border-outline-variant/10 hover:border-primary/30 transition-all duration-300">
