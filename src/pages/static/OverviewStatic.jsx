      ...
      <div className="flex h-screen pt-14">
        ...
        <aside className="hidden md:flex flex-col h-full w-64 bg-[#0b1326] py-6 px-4 gap-y-1 overflow-y-auto border-r border-white/5 font-['Inter'] font-medium text-sm">
          ...
          <nav className="flex flex-col gap-1">
            <a href="index.html" className="flex items-center gap-3 px-3 py-2.5 text-indigo-300 bg-[#2d3449] rounded-lg shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] active:translate-x-1 transition-transform">
              <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>dashboard</span>
              <span>Overview</span>
            </a>
            <a href="mining.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">bolt</span>
              <span>Mining</span>
            </a>
            <a href="tradingbots.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">swap_horiz</span>
              <span>Trading</span>
            </a>
            <a href="staking.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">layers</span>
              <span>Staking</span>
            </a>
            <a href="dao.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">account_balance</span>
              <span>DAOs</span>
            </a>
            <a href="business.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">business_center</span>
              <span>Business</span>
            </a>
            <a href="marketplace.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">shopping_cart</span>
              <span>Marketplace</span>
            </a>
            <a href="academy.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
              <span className="material-symbols-outlined">school</span>
              <span>Academy</span>
            </a>
            <div className="h-px bg-white/5 my-4"></div>
            <a href="mcps.html" className="flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:text-slate-300 hover:bg-[#131b2e] transition-all duration-300">
