...
{/*  Hero Banner Section  */}
<section className="relative h-72 rounded-3xl overflow-hidden mb-8 group">
...
<div className="relative h-full flex flex-col justify-center px-8 max-w-4xl">
...
<div className="bg-surface-container-low rounded-2xl p-4 relative overflow-hidden group">
...
<h2 className="text-2xl font-semibold text-on-surface">Continue Learning</h2>
...
<div className="absolute top-3 left-3 px-2 py-1 bg-surface-container-highest/80 backdrop-blur-md rounded-md text-[10px] font-bold text-on-surface uppercase">Beginner</div>
</div>
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="text-on-surface font-semibold text-base group-hover:text-primary transition-colors">Intro to $NEURONS</h3>
...
<div className="absolute top-3 left-3 px-2 py-1 bg-surface-container-highest/80 backdrop-blur-md rounded-md text-[10px] font-bold text-on-surface uppercase">Advanced</div>
</div>
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="text-on-surface font-semibold text-base group-hover:text-primary transition-colors">Smart Contract Auditing</h3>
<span className="material-symbols-outlined text-outline text-lg">more_vert</span>
</div>
...
<div className="absolute top-3 left-3 px-2 py-1 bg-surface-container-highest/80 backdrop-blur-md rounded-md text-[10px] font-bold text-on-surface uppercase">Intermediate</div>
</div>
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="text-on-surface font-semibold text-base group-hover:text-primary transition-colors">DeFi Yield Strategies</h3>
<span className="material-symbols-outlined text-outline text-lg">more_vert</span>
</div>
...
<div className="absolute top-3 left-3 px-2 py-1 bg-surface-container-highest/80 backdrop-blur-md rounded-md text-[10px] font-bold text-on-surface uppercase">Pro</div>
</div>
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="text-on-surface font-semibold text-base group-hover:text-primary transition-colors">Cybersecurity Protocol</h3>
<span className="material-symbols-outlined text-outline text-lg">more_vert</span>
</div>
