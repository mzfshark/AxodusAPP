...
- Add Governance design and information architecture — 35%; `.instructions/design/governance/DESIGN.md` defines Governance as an Economic Infrastructure Control Plane and DAO Tenant Operations Center, with required operational density, treasury visibility, federation topology, proposal execution metadata, design-token reuse and low-noise institutional UI direction
